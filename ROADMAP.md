...
| 12 | **PKG-DEV · Self-improvement and engineering** | Evidence-linked diagnosis/proposal, approved bounded OpenCode execution, tests and rollback | **Wave 1 merged via PR #99:** evidence-linked proposal screening, bounded workspace paths and an authorization-gated OpenCode adapter are on `main`. Git-SHA verification, post-edit diff enforcement, automated tests/rollback and live host acceptance remain. |
...
| 16 | **PKG-KNOW · Documents, reference knowledge, and provenance** | Read trusted manuals, PDFs, code/docs, project notes and later approved web material; preserve source/version/provenance, freshness, citations and correction state | **Wave 1 merged via PR #99:** provenance-bearing document/fact models and registry are on `main`. Local/PDF/repo ingestion, durable indexing, freshness/correction and citation projection remain. No general web grant. |
| 17 | **PKG-INTEGRATE · Applications, services, and tool adapters** | Typed integrations to Home Assistant, JMRI, GitHub, Docker/Portainer, Hyper-V, Cloudflare, databases, Ollama and future services; includes governed self-tooling from documentation | **Wave 1 merged via PR #99:** typed manifests, adapter registry, external authority gate and invocation receipts are on `main`. Schema/capability policy enforcement, durable receipts, lifecycle/rollback and live service adapters remain open. |
