> **Live quality repair update — 2026-09-24:** PKG-DISCORD v1 is merged via PR #64 (`ba2111b`). Supervised owner-DM use proved canonical embodiment projection still works while ordinary greetings can fall back to generic assistant wording. Open a joint INTERACT/CORE repair gate for natural, non-canned expression without reopening accepted interaction safety/ledger semantics. SOCIAL separately owns projecting the authenticated owner principal into cognition as Sparks.
