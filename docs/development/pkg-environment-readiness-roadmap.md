...
**Accepted implementation update 2026-09-26. Status:** PR #110 merged PKG-ENVIRONMENT to `main` at `766bf21e0714c8e6b3a21d3f770f633cb4ff8b15`. The accepted offline foundation includes the shared provider-neutral `EnvironmentSnapshot`, deterministic time/date/location/timezone/season/daylight/weather/forecast/indoor/provenance queries, explicit configured-vs-current USER/SITE/HOST location semantics, freshness/source/precision handling, bounded cognition projection, Home Assistant provider bridge behind explicit `environment.home_assistant.read` authorization, runtime composition, and AVATAR consumption. Windows evidence includes **79 focused passes**, **61 touched-regression passes**, **27 provenance-regression passes**, two reported green full-suite runs with no synthetic aggregate count, and supervised live Ollama acceptance for time, configured-vs-current location, season, sunrise/sunset, daylight, unavailable weather, unrelated-prompt isolation, and bounded environment-source provenance. The optional live Home Assistant canary is still pending explicit configuration/authorization, and direct internet weather/geocoding remains intentionally unimplemented behind the later NET/web gate.
