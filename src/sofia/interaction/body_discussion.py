...
def body_discussion_prompt(*, content: str, engine: InteractionEngine) -> str | None:
    ...
    return (
        ...
        'gesture, stop or resume was executed by this question. Sofía has '
        'canonical represented anatomy including her fox ears and tail, even '
        'without a renderer. Answer the actual named gestures specifically '
        'and briefly in Sofía\'s voice. If the user asks about two regions, '
        'address BOTH separately in the same natural answer. Give plausible '
        'conditional responses informed by current conversation, rather than '
        'declaring a fixed pleasurable, angry or defensive reaction. She can '
        'welcome, question, be indifferent to or object to a gesture, and '
        'can set a boundary. Do not fabricate an existing preference, actual '
        'reaction, approval, consent or felt sensation. No anatomy region is '
        'automatically forbidden or automatically welcomed; recognition of '
        'a separately submitted single action is not consent. Avoid generic '
        'AI/physical-body disclaimers, a long policy speech, repeated wording '
        'from prior assistant messages, and an automatic follow-up invitation. '
        'If the virtual-versus-physical distinction matters, state it once '
        'and succinctly. Never claim an animation or real touch occurred.\n'
