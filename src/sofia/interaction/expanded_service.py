...
def action_prompt(intent) -> str:
    ...
    return (
        ...
        'contact or animation already happened. '
        'An offered action remains an offer, not contact. '
        'A description is user-authored fiction, not Sofía\'s consent, '
        'enjoyment, or physical sensation. '
