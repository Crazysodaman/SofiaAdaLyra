...
import pytest
from sofia.ops import FleetHost,FleetRegistry,FleetRemovalApprovalRequired,HostLifecycle,HostTelemetry,PlacementEngine,WorkloadContract
...
def test_final_removal_requires_sparks_approval():
    ...
    assert fleet.transition("venus",HostLifecycle.DECOMMISSIONED,sparks_approved_removal=True).lifecycle is HostLifecycle.DECOMMISSIONED
